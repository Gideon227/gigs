...
const AboutSection = () => {
  return (
    <div className='px-16 pt-24 pb-12 bg-[#101217] space-y-6 max-lg:px-6 '>
       <h1 className='flex lg:w-1/2 justify-start items-center font-semibold text-[32px] leading-[48px] text-heading text-start max-md:text-[28px] max-lg:leading-[35px]'>
